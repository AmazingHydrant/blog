    ...
    <div id="side-nav">
        <ul id="nav">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('分類列表','/admin/cate')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>分類列表</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('添加分類','/admin/cate/create')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>添加分類</cite></a>
                    </li>
                </ul>
            ...
            <li>
                <a href="javascript:;">
                    <i class="iconfont left-nav-li" lay-tips="系统統計">&#xe6ce;</i>
                    <cite>系统统计</cite>
                    <i class="iconfont nav_right">&#xe697;</i></a>
                <ul class="sub-menu">
                    <li>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a onclick="xadmin.add_tab('错误頁面','error.html')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>错误頁面</cite></a>
                    </li>
                    <li>

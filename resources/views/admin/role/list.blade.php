      ...
      <div class="layui-col-md12">
        <div class="layui-card">
          ...
          <div class="layui-card-header">
            ...
            <button class="layui-btn" onclick="xadmin.open('新增會員','/admin/role/create',600,400)"><i class="layui-icon"></i>新增</button>
          </div>
            ...
            <table class="layui-table layui-form">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{$u->updated_at}}</td>
                  <td class="td-manage">
                    <a title="權限" onclick="xadmin.open('權限','/admin/role/auth/{{$u->id}}',600,400)" href="javascript:;">
                      <i class="layui-icon">&#xe770;</i>
                    </a>
                    <a title="编辑" onclick="xadmin.open('编辑','/admin/role/{{$u->id}}/edit',600,400)" href="javascript:;">
                      <i class="layui-icon">&#xe642;</i>
                    </a>
